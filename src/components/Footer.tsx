                ...
                <div className="text-center sm:text-left sm:col-span-2">
                   <div className="flex items-center justify-center gap-2 sm:justify-start">
                     ...
                     <p className="mt-4 text-sm text-muted-foreground">
                        A free, open-source learning platform providing a plan for learning and a foundation for creative expression. We provide AI-powered tools in a safe, anonymous environment—no student sign-ups required.
                    </p>
                </div>
